...
// Estilização do Botão de Pedidos
export const OptionBuy = styled.TouchableOpacity`
...
export const InfoBuy = styled.ScrollView`
  margin-left: 20px;
`;

export const TitleBuy = styled.Text`
  color: #FFF;
  font-size: 18px;
`;

export const DescriptionBuy = styled.Text`
  font-size: 16px;
  color: #FFF;
`;